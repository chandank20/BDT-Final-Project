...
public class SparkKafkaConsumer {
	...
	private SparkResources spResources;
	private String lastKey="";
	public SparkKafkaConsumer(SparkResources sparkResources)
	{
		this.spResources = sparkResources;
		Properties props = new Properties();
	    props.put("bootstrap.servers", "localhost:"+ spResources.PORT);
	    ...
	    this.consumer.subscribe(Arrays.asList(spResources.TOPIC));
